...
//    }
    ...
    private val itemReportRepository: ItemReportRepository
    val reportDetails: LiveData<List<PopupData>>
    init {
        val itemReportDao = AppDatabase.getDatabase(application).itemReportDao()
        itemReportRepository = ItemReportRepository(itemReportDao)
    ...
    suspend fun isDuplicateReport(
        ...
        return itemReportRepository.isDuplicateReport(itemId, userId, weight, date, time)
    }
